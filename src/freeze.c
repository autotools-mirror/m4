  ...
  do
    {
      switch (SYMBOL_TYPE (sym))
        ...
        case TOKEN_TEXT:
          xfprintf (file, "T%d,%d\n",
                    (int) SYMBOL_NAME_LEN (sym), (int) SYMBOL_TEXT_LEN (sym));
        ...
        case TOKEN_FUNC:
          ...
          xfprintf (file, "F%d,%d\n",
                    (int) SYMBOL_NAME_LEN (sym), (int) strlen (bp->name));
          xfwrite (SYMBOL_NAME (sym), 1, SYMBOL_NAME_LEN (sym), file);
          fputs (bp->name, file);
          fputc ('\n', file);
          break;
...
produce_frozen_state (const char *name)
{
  ...
  if (curr_comm.len1 != 1 || curr_comm.len2 != 1
    ...
    {
      xfprintf (file, "C%d,%d\n", (int) curr_comm.len1, (int) curr_comm.len2);
